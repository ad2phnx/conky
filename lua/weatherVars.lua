...
images = {
  ...
  -- current condition
  {
    ...
    w = 128,
    h = 128,
    file = os.getenv("HOME") .. '/.config/gen2con/weather/' .. ((weather ~= nil and weather.cc ~= nil) and weather.cc.icon or 'NA') .. '.png',
  },
  ...
  -- Moon
  {
    ...
    w = 48,
    h = 48,
    file = os.getenv("HOME") .. '/.config/gen2con/moon/' .. ((weather ~= nil and weather.cc ~= nil) and weather.cc.moon.icon or 'NA') .. '.png',
    rotate = true,
